...
export function useAuth(): UseAuthReturn {
  ...
  const validateStoredToken = useCallback(async () => {
    ...
    if (storedExpiration) {
      const expiration = Number.parseInt(storedExpiration, 10)
  ...
  const updateUserInDatabase = async (uid: string, userData: Partial<User> & { tokenExpiration?: number }) => {
